                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th class="td-sno">#</th>
                                                <th  class="td-Nomor_Agenda"> Nomor Agenda</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            $rec_id = (!empty($data['Nomor_Agenda']) ? urlencode($data['Nomor_Agenda']) : null);
                                            $counter++;
                                            ?>
                                            <tr>
                                                <th class=" td-checkbox">
                                                    <label class="custom-control custom-checkbox custom-control-inline">
                                                        <input class="optioncheck custom-control-input" name="optioncheck[]" value="<?php echo $data['Nomor_Agenda'] ?>" type="checkbox" />
                                                            <span class="custom-control-label"></span>
                                                        </label>
                                                    </th>
                                                    <th class="td-sno"><?php echo $counter; ?></th>
                                                    <td class="td-Nomor_Agenda"><a href="<?php print_link("surat_masuk/view/$data[Nomor_Agenda]") ?>"><?php echo $data['Nomor_Agenda']; ?></a></td>
                                                    <td class="td-Nomor_Surat">
                                                        <span  data-value="<?php echo $data['Nomor_Surat']; ?>" 
                                                            data-pk="<?php echo $data['Nomor_Agenda'] ?>" 
                                                            data-url="<?php print_link("surat_masuk/editfield/" . urlencode($data['Nomor_Agenda'])); ?>" 
