 ...
 * @category  Controller
 */
class Surat_keluarController extends BaseController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("Tanggal_Surat","Tujuan_Surat","Nomor_Surat","Perihal");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("No_Agenda","Tanggal_Surat","Tujuan_Surat","Nomor_Surat","Perihal");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'Tanggal_Surat' => 'required',
