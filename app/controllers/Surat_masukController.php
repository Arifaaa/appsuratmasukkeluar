...
class Surat_masukController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				surat_masuk.Nomor_Agenda LIKE ? OR 
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy("surat_masuk.Nomor_Agenda", ORDER_TYPE);
		}
		if($fieldname){
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("surat_masuk.Nomor_Agenda", $rec_id);; //select record based on primary key
		}
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("Nomor_Surat","Tanggal_Surat","Tanggal_Terima","Asal_Surat","Perihal");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("Nomor_Agenda","Nomor_Surat","Tanggal_Surat","Tanggal_Terima","Asal_Surat","Perihal");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'Nomor_Surat' => 'required',
			...
			$modeldata = $this->modeldata = $this->validate_form($postdata);
			if($this->validated()){
				$db->where("surat_masuk.Nomor_Agenda", $rec_id);;
	...
	function delete($rec_id = null){
		...
		$db->where("surat_masuk.Nomor_Agenda", $arr_rec_id, "in");
